...
int load_module(const char *path)
{
    ...
    g_call_core_has_synced_meta_data = GET_FUNC(module, "Core_HasSyncedMeta", capi_core_has_synced_meta_data);
    g_call_core_get_synced_meta_data = GET_FUNC(module, "Core_GetSyncedMeta", capi_core_get_synced_meta_data);
