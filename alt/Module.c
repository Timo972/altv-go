...
// src\capi\BaseObject.h Module.c
...
{
    return g_call_blip_set_meta_data(base, key, data, size);
}
...
{
    return g_call_blip_set_scale_x_y(b, scale);
}
...
// src\capi\Checkpoint.h Module.c
...
{
    return g_call_checkpoint_set_meta_data(base, key, data, size);
}
...
{
    return g_call_checkpoint_destroy(b);
}
...
{
    return g_call_col_shape_set_meta_data(base, key, data, size);
}
...
{
    return g_call_col_shape_destroy(b);
}
...
capi_core_create_m_value_list g_call_core_create_m_value_list;
capi_core_create_m_value_dict g_call_core_create_m_value_dict;
capi_core_create_m_value_base_object g_call_core_create_m_value_base_object;
capi_core_create_m_value_vector2 g_call_core_create_m_value_vector2;
capi_core_create_m_value_vector3 g_call_core_create_m_value_vector3;
capi_core_create_m_value_r_g_b_a g_call_core_create_m_value_r_g_b_a;
capi_core_create_m_value_byte_array g_call_core_create_m_value_byte_array;
...
capi_core_get_m_value_base_object g_call_core_get_m_value_base_object;
capi_core_get_m_value_vector2 g_call_core_get_m_value_vector2;
capi_core_get_m_value_vector3 g_call_core_get_m_value_vector3;
capi_core_get_m_value_r_g_b_a g_call_core_get_m_value_r_g_b_a;
capi_core_get_m_value_byte_array g_call_core_get_m_value_byte_array;
capi_core_get_m_value_list g_call_core_get_m_value_list;
capi_core_get_m_value_dict g_call_core_get_m_value_dict;
...
{
    return g_call_core_get_m_value_base_object(val);
}

Vector2 core_get_m_value_vector2(void *val)
{
    return g_call_core_get_m_value_vector2(val);
}

Position core_get_m_value_vector3(void *val)
{
    return g_call_core_get_m_value_vector3(val);
}

RGBA core_get_m_value_r_g_b_a(void *val)
{
    return g_call_core_get_m_value_r_g_b_a(val);
}

Array core_get_m_value_byte_array(void *val)
{
    return g_call_core_get_m_value_byte_array(val);
}

Array core_get_m_value_list(void *val)
{
    return g_call_core_get_m_value_list(val);
}

MValueDict core_get_m_value_dict(void *val)
{
    return g_call_core_get_m_value_dict(val);
}
...
{
    return g_call_core_set_meta_data(key, data, size);
}
...
{
    return g_call_core_set_synced_meta_data(key, data, size);
}
...
{
    return g_call_core_trigger_local_event(ev, MValues, mValuesSize);
}

void core_trigger_client_event(void *p, const char *ev, CustomData *MValues, unsigned long long size)
{
    return g_call_core_trigger_client_event(p, ev, MValues, size);
}
...
{
    return g_call_core_trigger_client_event_for(*p, clientSize, ev, MValues, size);
}

void core_trigger_client_event_for_all(const char *ev, CustomData *MValues, unsigned long long size)
{
    return g_call_core_trigger_client_event_for_all(ev, MValues, size);
}
...
{
    return g_call_core_stop_server();
}
...
{
    return g_call_player_set_meta_data(base, key, data, size);
}
...
{
    return g_call_player_set_synced_meta_data(base, key, data, size);
}
...
{
    return g_call_player_set_stream_synced_meta_data(base, key, data, size);
}
...
{
    return g_call_player_destroy(p);
}
...
{
    return g_call_player_set_streamed(p, toggle);
}
...
{
    return g_call_player_set_invincible(p, toggle);
}

void player_set_into_vehicle(void *p, void *v, unsigned char seat)
{
    return g_call_player_set_into_vehicle(p, v, seat);
}
...
{
    return g_call_player_set_local_meta_data(p, key, data, size);
}
...
{
    return g_call_runtime_register_alt_export(resourceName, exportName, data);
}
...
{
    return g_call_runtime_call_m_value_function(ptr, mValues, mValueSize);
}
...
{
    return g_call_vehicle_set_meta_data(base, key, data, size);
}
...
{
    return g_call_vehicle_set_synced_meta_data(base, key, data, size);
}
...
{
    return g_call_vehicle_set_stream_synced_meta_data(base, key, data, size);
}
...
{
    return g_call_vehicle_load_appearance_data_from_base64(v, base64);
}
...
{
    return g_call_vehicle_load_damage_data_from_base64(v, base64);
}

void vehicle_load_script_data_from_base64(void *v, const char *base64)
{
    return g_call_vehicle_load_script_data_from_base64(v, base64);
}

void vehicle_load_game_state_from_base64(void *v, const char *base64)
{
    return g_call_vehicle_load_game_state_from_base64(v, base64);
}

void vehicle_load_health_data_from_base64(void *v, const char *base64)
{
    return g_call_vehicle_load_health_data_from_base64(v, base64);
}
...
{
    return g_call_vehicle_destroy(v);
}
...
{
    return g_call_vehicle_set_streamed(v, toggle);
}
...
{
    return g_call_vehicle_set_train_unk1(v, unk1);
}
...
{
    return g_call_vehicle_set_train_unk2(v, unk2);
}
...
{
    return g_call_vehicle_set_train_unk3(v, unk3);
}
...
{
    return g_call_voice_channel_delete_meta_data(base, key);
}

void voice_channel_destroy(void *b)
{
    return g_call_voice_channel_destroy(b);
}
...
{
    return g_call_voice_channel_add_player(v, p);
}

void voice_channel_remove_player(void *v, void *p)
{
    return g_call_voice_channel_remove_player(v, p);
}
...
{
    return g_call_voice_channel_mute_player(v, p);
}

void voice_channel_unmute_player(void *v, void *p)
{
    return g_call_voice_channel_unmute_player(v, p);
}
...
int load_module(const char *path)
{
    ...
    // src\capi\BaseObject.h int load_module(const char *path);

// src\capi\Blip.h int load_module(const char *path);
...
// src\capi\Checkpoint.h int load_module(const char *path);
...
// src\capi\ColShape.h int load_module(const char *path);
...
// src\capi\Core.h int load_module(const char *path);
...
g_call_core_create_m_value_list = GET_FUNC(module, "Core_CreateMValueList", capi_core_create_m_value_list);
g_call_core_create_m_value_dict = GET_FUNC(module, "Core_CreateMValueDict", capi_core_create_m_value_dict);
g_call_core_create_m_value_base_object = GET_FUNC(module, "Core_CreateMValueBaseObject", capi_core_create_m_value_base_object);
g_call_core_create_m_value_vector2 = GET_FUNC(module, "Core_CreateMValueVector2", capi_core_create_m_value_vector2);
g_call_core_create_m_value_vector3 = GET_FUNC(module, "Core_CreateMValueVector3", capi_core_create_m_value_vector3);
g_call_core_create_m_value_r_g_b_a = GET_FUNC(module, "Core_CreateMValueRGBA", capi_core_create_m_value_r_g_b_a);
g_call_core_create_m_value_byte_array = GET_FUNC(module, "Core_CreateMValueByteArray", capi_core_create_m_value_byte_array);
...
g_call_core_get_m_value_base_object = GET_FUNC(module, "Core_GetMValueBaseObject", capi_core_get_m_value_base_object);
g_call_core_get_m_value_vector2 = GET_FUNC(module, "Core_GetMValueVector2", capi_core_get_m_value_vector2);
g_call_core_get_m_value_vector3 = GET_FUNC(module, "Core_GetMValueVector3", capi_core_get_m_value_vector3);
g_call_core_get_m_value_r_g_b_a = GET_FUNC(module, "Core_GetMValueRGBA", capi_core_get_m_value_r_g_b_a);
g_call_core_get_m_value_byte_array = GET_FUNC(module, "Core_GetMValueByteArray", capi_core_get_m_value_byte_array);
g_call_core_get_m_value_list = GET_FUNC(module, "Core_GetMValueList", capi_core_get_m_value_list);
g_call_core_get_m_value_dict = GET_FUNC(module, "Core_GetMValueDict", capi_core_get_m_value_dict);
...
// src\capi\VoiceChannel.h int load_module(const char *path);
