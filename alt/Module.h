...
typedef void (*capi_player_attach_to_entity)(void *p, Entity e, int otherBoneIndex, int myBoneIndex, Position position, Rotation rotation, int collision, int noFixedRotation);
...
typedef void (*capi_vehicle_attach_to_entity)(void *v, Entity e, int otherBoneIndex, int myBoneIndex, Position position, Rotation rotation, int collision, int noFixedRotation);
...
typedef Vector2 (*capi_core_get_mvalue_vector2)(void *val);
...
typedef MetaData (*capi_blip_get_meta_data)(void *base, const char *key);
typedef void (*capi_blip_set_meta_data)(void *base, const char *key, void *val);
...
typedef void (*capi_blip_set_scale_xy)(void *b, float x, float y);
