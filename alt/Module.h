...
typedef unsigned long (*capi_player_get_seat)(void *p);
...
typedef void (*capi_player_set_max_armour)(void *p, unsigned long armour);
typedef void (*capi_player_set_current_weapon)(void *p, unsigned long weapon);
typedef void (*capi_player_set_weapon_tint_index)(void *p, unsigned long weapon, unsigned long tintIndex);
...
typedef void (*capi_player_give_weapon)(void *p, unsigned long weapon, unsigned long ammo, bool selectWeapon);
...
typedef void (*capi_player_attach_to_entity)(void *p, void *e, unsigned long otherBoneIndex, unsigned long myBoneIndex, Position position, Rotation rotation, bool collision, bool noFixedRotation);
