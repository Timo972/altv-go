...
typedef void (*capi_vehicle_attach_to_entity)(void *v, void *e, int otherBoneIndex, int myBoneIndex, Position position, Rotation rotation, bool collision, bool noFixedRotation);
typedef void (*capi_vehicle_set_visible)(void *v, bool toggle);
typedef bool (*capi_vehicle_get_visible)(void *v);
typedef void * (*capi_vehicle_get_network_owner)(void *v);
typedef void (*capi_vehicle_set_network_owner)(void *v, void *owner, bool disableMigration);
typedef void * (*capi_vehicle_get_driver)(void *v);
typedef bool (*capi_vehicle_is_destroyed)(void *v);
...
typedef bool (*capi_vehicle_is_tire_smoke_color_custom)(void *v);
...
typedef bool (*capi_vehicle_get_custom_tires)(void *v);
...
typedef bool (*capi_vehicle_is_extra_on)(void *v, unsigned int extraID);
typedef bool (*capi_vehicle_is_neon_active)(void *v);
typedef void (*capi_vehicle_get_neon_active)(void *v, bool *left, bool *right, bool *front, bool *back);
...
typedef bool (*capi_vehicle_is_engine_on)(void *v);
typedef bool (*capi_vehicle_is_handbrake_active)(void *v);
...
typedef bool (*capi_vehicle_is_siren_active)(void *v);
...
typedef bool (*capi_vehicle_is_window_opened)(void *v, unsigned int windowId);
typedef bool (*capi_vehicle_is_daylight_on)(void *v);
typedef bool (*capi_vehicle_is_nightlight_on)(void *v);
typedef unsigned long (*capi_vehicle_get_roof_state)(void *v);
typedef bool (*capi_vehicle_is_flamethrower_active)(void *v);
...
typedef bool (*capi_vehicle_is_wheel_burst)(void *v, unsigned int wheelId);
typedef bool (*capi_vehicle_does_wheel_has_tire)(void *v, unsigned int wheelId);
typedef bool (*capi_vehicle_is_wheel_detached)(void *v, unsigned int wheelId);
typedef bool (*capi_vehicle_is_wheel_on_fire)(void *v, unsigned int wheelId);
...
typedef bool (*capi_vehicle_is_light_damaged)(void *v, unsigned int lightId);
typedef bool (*capi_vehicle_is_window_damaged)(void *v, unsigned int windowId);
typedef bool (*capi_vehicle_is_special_light_damaged)(void *v, unsigned int specialLightId);
typedef bool (*capi_vehicle_has_armored_windows)(void *v);
...
typedef bool (*capi_vehicle_is_manual_engine_control)(void *v);
typedef void (*capi_vehicle_toggle_extra)(void *v, unsigned int extraID, bool state);
typedef void (*capi_vehicle_set_fixed)(void *v);
typedef bool (*capi_vehicle_set_mod)(void *v, unsigned int category, unsigned int id);
typedef bool (*capi_vehicle_set_mod_kit)(void *v, unsigned int id);
...
typedef void (*capi_vehicle_set_custom_tires)(void *v, bool state);
...
typedef void (*capi_vehicle_set_neon_active)(void *v, bool left, bool right, bool front, bool back);
...
typedef void (*capi_vehicle_set_engine_on)(void *v, bool state);
...
typedef void (*capi_vehicle_set_siren_active)(void *v, bool state);
...
typedef void (*capi_vehicle_set_window_opened)(void *v, unsigned int windowId, bool state);
...
typedef void (*capi_vehicle_set_wheel_burst)(void *v, unsigned int wheelId, bool state);
typedef void (*capi_vehicle_set_wheel_has_tire)(void *v, unsigned int wheelId, bool state);
typedef void (*capi_vehicle_set_wheel_detached)(void *v, unsigned int wheelId, bool state);
typedef void (*capi_vehicle_set_wheel_on_fire)(void *v, unsigned int wheelId, bool state);
...
typedef void (*capi_vehicle_set_light_damaged)(void *v, unsigned int lightId, bool isDamaged);
typedef void (*capi_vehicle_set_window_damaged)(void *v, unsigned int windowId, bool isDamaged);
typedef void (*capi_vehicle_set_special_light_damaged)(void *v, unsigned int specialLightId, bool isDamaged);
...
typedef void (*capi_vehicle_set_manual_engine_control)(void *v, bool state);
