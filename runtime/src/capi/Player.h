...
EXPORT void Player_RemoveAllWeapons(void *p, unsigned short removeAmmo);
...
EXPORT void
Player_AttachToEntity(void *p, CBaseObject e, int otherBoneIndex, int myBoneIndex, float posX, float posY, float posZ, float rotX, float rotY, float rotZ,
