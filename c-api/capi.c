...
{
    g_call_blip_set_meta_data(base, key, data, size);
}
...
{
    g_call_checkpoint_set_meta_data(base, key, data, size);
}
...
{
    g_call_col_shape_set_meta_data(base, key, data, size);
}
...
{
    g_call_core_set_meta_data(key, data, size);
}
...
{
    g_call_core_set_synced_meta_data(key, data, size);
}
...
{
    g_call_player_set_meta_data(base, key, data, size);
}
...
{
    g_call_player_set_synced_meta_data(base, key, data, size);
}
...
{
    g_call_player_set_stream_synced_meta_data(base, key, data, size);
}
...
{
    g_call_player_set_local_meta_data(p, key, data, size);
}
...
{
    return g_call_runtime_register_alt_export(resourceName, exportName, data, size);
}
...
{
    g_call_vehicle_set_meta_data(base, key, data, size);
}
...
{
    g_call_vehicle_set_synced_meta_data(base, key, data, size);
}
...
{
    g_call_vehicle_set_stream_synced_meta_data(base, key, data, size);
}
...
{
    g_call_voice_channel_set_meta_data(base, key, data, size);
}
